...
## Database Setup Explain how to open and run the SQL script in SSMS.
SQL script is included named: raceday.sql you can compy the contents nd past them in a SSMS file and run or  and required tables will be created with seed data.
